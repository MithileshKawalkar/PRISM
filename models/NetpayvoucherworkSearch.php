...
/**
 * NetpayvoucherworkSearch represents the model behind the search form of `app\models\Netpayvoucherwork`.
 */
class NetpayvoucherworkSearch extends Netpayvoucherwork
{
    /**
     * {@inheritdoc}
     */
